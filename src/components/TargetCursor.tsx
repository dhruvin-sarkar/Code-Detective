...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    // React unmounts targets without firing mouseleave (phase changes,
    // route changes, buttons that disappear once pressed). If the locked
    // target leaves the DOM, release the lock — otherwise the corner
    // brackets freeze at a stale position forever.
